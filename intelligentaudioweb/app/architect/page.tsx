        ...
        <div className="min-h-screen bg-[#02040a] text-slate-50 font-sans selection:bg-blue-500/30">
            ...
            <section className="space-y-6 mt-4">
                <h2 className="text-2xl font-semibold flex items-center gap-2">
                    <Layout className="w-6 h-6" /> Project Structure
                </h2>
                <div className="grid gap-4">
                    {[
                        { title: "IntelligentAudio.Contracts", desc: "Abstractions & Zero external dependencies.", badge: "No Deps" },
                        { title: "IntelligentAudio.Infrastructure", desc: "Technical implementation and I/O (UDP/OSC).", badge: "I/O" },
                        { title: "IntelligentAudioEngine", desc: "The Brain. Whisper.net and Span logic.", badge: "Real-time" },
                        { title: "IntelligentAudio.Server", desc: "Composition Root and DI setup.", badge: "Host" },
